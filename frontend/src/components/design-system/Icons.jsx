...
export const TrendDownIcon = ({ size = 16, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path d="M2 5l4 4 3-3 5 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M10 12h4v-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const UploadCloudIcon = ({ size = 32, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
    <path d="M10 22a6 6 0 01-1-11.93A8 8 0 1124.83 16H25a4 4 0 010 8h-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M16 18v8M13 21l3-3 3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const HomeIcon = ({ size = 22, className = "" }) => (
...
export const DumbbellIcon = ({ size = 22, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 22 22" fill="none" className={className}>
    ...
    <rect x="6" y="6" width="2" height="10" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="14" y="6" width="2" height="10" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M8 11h6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);

export const ChartBarIcon = ({ size = 22, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 22 22" fill="none" className={className}>
    <path d="M3 17h3v-6H3v6zM9 17h3V7H9v10zM15 17h3v-3h-3v3z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
    <path d="M3 20h16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const UsersIcon = ({ size = 22, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 22 22" fill="none" className={className}>
    ...
    <path d="M15 6a3 3 0 010 5M19 19c0-2.76-1.79-5.11-4.25-5.84" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const UserIcon = ({ size = 22, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 22 22" fill="none" className={className}>
    ...
    <path d="M4 19c0-3.866 3.134-7 7-7h.5c3.866 0 7 3.134 7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);

export const BoltIcon = ({ size = 16, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path d="M9 2L3 9h5l-1 5 6-7H8l1-5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
  </svg>
);
...
export const FlameIcon = ({ size = 16, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path d="M8 2s3 2.5 2 5c1-1 1.5-2.5 1-4 2 1.5 3 4 1.5 7C11.5 12.5 10 14 8 14s-3.5-1.5-4.5-4C2 7.5 3 5 5 3.5c0 1.5.5 2.5 1.5 3C6 5 7 3.5 8 2z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
  </svg>
);
...
export const CalendarIcon = ({ size = 16, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    ...
    <path d="M1.5 6.5h13M5 1.5v2M11 1.5v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const SpinnerIcon = ({ size = 16, className = "" }) => (
  <span
    ...
    className={`inline-block rounded-full border-2 border-current border-t-transparent animate-spin-slow ${className}`}
  />
);
